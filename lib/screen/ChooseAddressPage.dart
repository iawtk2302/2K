                ...
                child: Column(
                  children: [
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: ItemAddress(address: state.listAddress[index],
                          icon: IconButton(icon:state.listAddress[index]==state.tempAddress?const Icon(Icons.radio_button_checked):Icon(Icons.radio_button_unchecked), onPressed: () {  
                            BlocProvider.of<OrderBloc>(context).add(ChooseAddress(state.listAddress[index]));
                          },),),
                        );
                      }),
                    Padding(
                      padding: const EdgeInsets.symmetric(vertical: 16),
                      child: CustomElevatedButton(text: "Add New Address", 
                      onTap: (){
                    ...
                    Padding(
                      ...
                      onTap: ()async{
                        BlocProvider.of<OrderBloc>(context).add(ApplyAddress());
                      }, 
                      color: Colors.black,
